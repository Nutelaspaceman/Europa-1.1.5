...
extends Element {
    ...
    public String getText() {
        return (mode.getValue().equals((Object)Modes.Custom) ? customValue.getValue() : "Europa") + (!version.getValue().equals((Object)Versions.None) ? " " + (Object)this.getVersionColor() + (version.getValue().equals((Object)Versions.Normal) ? "v" : "") + "1.1.5" : "");
    }
