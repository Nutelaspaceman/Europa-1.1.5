...
extends Element {
    ...
    public String getWelcomeMessage() {
        switch (1.$SwitchMap$com$europa$client$elements$ElementWelcomer$Modes[((Modes)mode.getValue()).ordinal()]) {
            case 1: {
                return "Greetings, " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
            }
            case 2: {
                return this.getTimeOfDay() + ", " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
            }
            case 3: {
                return this.getHoliday() + ", " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
            }
            case 4: {
                return "Shalom, " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
            }
            case 5: {
                return "Welcome to Europa, " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
            }
            case 6: {
                return customValue.getValue().replaceAll("<player>", (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET);
            }
        }
        return "Hello, " + (Object)this.getNameColor() + this.getPlayerName() + (Object)ChatFormatting.RESET + "!";
    }
