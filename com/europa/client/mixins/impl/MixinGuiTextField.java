    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow((Object)ChatFormatting.GRAY + string, 4.0f, (float)(new ScaledResolution(Minecraft.getMinecraft()).getScaledHeight() - Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT - 3), -1);
