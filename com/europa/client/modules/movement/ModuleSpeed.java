...
extends Module {
    ...
    public void manageY(EventPlayerMove eventPlayerMove) {
        ...
        if (ModuleSpeed.mc.player.moveForward != Float.intBitsToFloat(Float.floatToIntBits(2.3037E38f) ^ 0x7F2D4FA6) || ModuleSpeed.mc.player.moveStrafing != Float.intBitsToFloat(Float.floatToIntBits(1.7930399E38f) ^ 0x7F06E4B1)) {
            if (ModuleSpeed.mc.player.onGround) {
                ...
                event.setY(ModuleSpeed.mc.player.motionY);
    ...
    public void onReceive(EventPacket.Receive receive) {
        void event;
        if (timer.getValue() && event.getPacket() instanceof SPacketPlayerPosLook) {
    ...
    public void onMove(EventPlayerMove eventPlayerMove) {
        ...
        if (moveForward == Double.longBitsToDouble(Double.doubleToLongBits(5.344542829584502E307) ^ 0x7FD306F6D85833E3L) && moveStrafe == Double.longBitsToDouble(Double.doubleToLongBits(1.3883286443143587E308) ^ 0x7FE8B68BC4908BF8L)) {
            event.setX(Double.longBitsToDouble(Double.doubleToLongBits(5.932969827784931E307) ^ 0x7FD51F4038F4EC95L));
            event.setZ(Double.longBitsToDouble(Double.doubleToLongBits(5.698898304712973E307) ^ 0x7FD449EB9D037E99L));
        ...
        this.manageY((EventPlayerMove)event);
        ...
        event.setX(moveForward * this.speed * toRadiansX + moveStrafe * this.speed * toRadiansZ);
        event.setZ(moveForward * this.speed * toRadiansZ - moveStrafe * this.speed * toRadiansX);
    ...
    public String getHudInfo() {
        String t = "";
        t = " [" + (Object)ChatFormatting.WHITE + mode.getValue() + (Object)ChatFormatting.GRAY + "]";
        return t;
    }
