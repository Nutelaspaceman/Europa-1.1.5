...
extends Module {
    ...
    public Vec3d getCenter(double d, double d2, double d3) {
        ...
        void posY;
        void posX;
        double x = Math.floor((double)posX) + Double.longBitsToDouble(Double.doubleToLongBits(10.889939534281096) ^ 0x7FC5C7A627964F3FL);
        double y = Math.floor((double)posY);
        double z = Math.floor((double)posZ) + Double.longBitsToDouble(Double.doubleToLongBits(16.861404934570704) ^ 0x7FD0DC8508A6981DL);
