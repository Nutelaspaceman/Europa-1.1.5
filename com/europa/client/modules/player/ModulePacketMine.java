...
extends Module {
    ...
    public void onBlock(EventBlock eventBlock) {
        block2: {
            ...
            if (!ModulePacketMine.canBlockBeBroken(event.pos)) break block2;
            if (this.breakPos == null) {
    ...
    public static boolean canBlockBeBroken(BlockPos blockPos) {
        BlockPos pos;
        IBlockState blockState = ModulePacketMine.mc.world.getBlockState(pos);
        Block block = blockState.getBlock();
        return block.getBlockHardness(blockState, (World)ModulePacketMine.mc.world, pos) != Float.intBitsToFloat(Float.floatToIntBits(-6.0870466f) ^ 0x7F42C916);
    }
    ...
    public String getHudInfo() {
        String t = "";
        if (this.breakPos == null) {
            t = " [" + (Object)ChatFormatting.WHITE + "No Block" + (Object)ChatFormatting.GRAY + "]";
        } else if (this.breakPos != null && !this.readyToMine) {
            t = " [" + (Object)ChatFormatting.RED + "Not Ready" + (Object)ChatFormatting.GRAY + "]";
        } else if (this.breakPos != null) {
            if (this.readyToMine) {
                t = " [" + (Object)ChatFormatting.GREEN + "Ready" + (Object)ChatFormatting.GRAY + "]";
            }
        }
        return t;
    }
