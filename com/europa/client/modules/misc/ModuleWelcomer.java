    ...
    public void playerJoined(NetworkPlayerInfo networkPlayerInfo) {
        block2: {
            ...
            if (privateMsg.getValue()) {
                ...
                ModuleWelcomer.mc.player.sendChatMessage(joinMessages.get(random.nextInt(joinMessages.size())) + playerInfo.getGameProfile().getName());
            }
        }
    }
    ...
    public void playerLeft(NetworkPlayerInfo networkPlayerInfo) {
        block2: {
            ...
            if (privateMsg.getValue()) {
                ...
                ModuleWelcomer.mc.player.sendChatMessage(leaveMessages.get(random.nextInt(leaveMessages.size())) + playerInfo.getGameProfile().getName());
            }
        }
    }
