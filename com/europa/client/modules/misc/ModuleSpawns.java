...
extends Module {
    ...
    public static void drawCircle(Entity entity, float f, double d, float f2, float f3) {
        ...
        GL11.glBegin((int)3);
        double x = entity2.lastTickPosX + (entity2.posX - entity2.lastTickPosX) * (double)partialTicks - ModuleSpawns.mc.getRenderManager().viewerPosX;
        double y = entity2.lastTickPosY + (entity2.posY - entity2.lastTickPosY) * (double)partialTicks - ModuleSpawns.mc.getRenderManager().viewerPosY;
        double z = entity2.lastTickPosZ + (entity2.posZ - entity2.lastTickPosZ) * (double)partialTicks - ModuleSpawns.mc.getRenderManager().viewerPosZ;
