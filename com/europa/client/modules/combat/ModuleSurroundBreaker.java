...
extends Module {
    ...
    public void onUpdate() {
        block14: {
            ...
            if (this.doPos != null) {
                if (this.doFace != null) {
                    if (this.timer.passed(Blocks.ANVIL.blockHardness * Float.intBitsToFloat(Float.floatToIntBits(0.39142433f) ^ 0x7F6868C5) * Float.intBitsToFloat(Float.floatToIntBits(0.96488684f) ^ 0x7F7702D3)) && InventoryUtils.getHotbarItemSlot(Items.DIAMOND_PICKAXE) != -1) {
