...
extends Module {
     ...
     */
    public BlockPos addToPosition(BlockPos blockPos, double d, double d2) {
        void z;
        void x;
        void position;
        block1: {
            ...
            if (position.getZ() >= 0) break block1;
            z = -z;
        }
        return position.add((double)x, Double.longBitsToDouble(Double.doubleToLongBits(1.4868164896774578E308) ^ 0x7FEA7759ABE7F7C1L), (double)z);
    }
    ...
    public boolean isSafe(BlockPos blockPos) {
        void position;
        return !ModuleSurround.mc.world.getBlockState((BlockPos)position).getBlock().isReplaceable((IBlockAccess)ModuleSurround.mc.world, (BlockPos)position);
    }
