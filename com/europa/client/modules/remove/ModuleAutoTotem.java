...
extends Module {
        ...
        block13: {
            ...
            block15: {
                ...
                block14: {
                    ...
                    block12: {
                        block11: {
                            this.totemCount = ModuleAutoTotem.mc.player.inventory.mainInventory.stream().filter(ModuleAutoTotem::lambda$onMotionUpdate$0).mapToInt(ItemStack::func_190916_E).sum();
    ...
    public void switchItem(int n) {
        void slot;
        ModuleAutoTotem.mc.playerController.windowClick(0, (int)slot, 0, ClickType.PICKUP, (EntityPlayer)ModuleAutoTotem.mc.player);
    ...
    public String getHudInfo() {
        String t = "";
        t = " [" + (Object)ChatFormatting.WHITE + this.totemCount + (Object)ChatFormatting.GRAY + "]";
        return t;
    }
