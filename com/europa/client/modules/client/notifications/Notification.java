...
public class Notification {
    ...
    public void onDraw(int n) {
        ...
        RenderUtils.drawRecta(-(this.width + Float.intBitsToFloat(Float.floatToIntBits(0.3717855f) ^ 0x7E3E5AAB)) + this.animationUtils2.getValue() - (this.isReversing && this.didFirstReverse ? this.reverse2.getValue() : Float.intBitsToFloat(Float.floatToIntBits(3.1289036E38f) ^ 0x7F6B647E)), (float)y, this.width + Float.intBitsToFloat(Float.floatToIntBits(0.20066918f) ^ 0x7ECD7C39), Float.intBitsToFloat(Float.floatToIntBits(0.7693848f) ^ 0x7EE4F667), ModuleColor.globalColor(255).getRGB());
        if (this.animationUtils2.isDone()) {
            ...
            Europa.FONT_MANAGER.drawString(ChatFormatting.stripFormatting((String)this.text), -(this.width + Float.intBitsToFloat(Float.floatToIntBits(0.694125f) ^ 0x7F31B22D)) + this.animationUtils.getValue() - (this.isReversing ? this.reverse.getValue() : Float.intBitsToFloat(Float.floatToIntBits(1.5466472E37f) ^ 0x7D3A2BBF)) + Float.intBitsToFloat(Float.floatToIntBits(0.2626216f) ^ 0x7E867657), (float)(y + 10) - Europa.FONT_MANAGER.getHeight() / Float.intBitsToFloat(Float.floatToIntBits(0.5751044f) ^ 0x7F133A0B), Color.WHITE);
        }
    }
}
