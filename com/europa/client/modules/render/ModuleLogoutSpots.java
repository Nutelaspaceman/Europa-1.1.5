...
extends Module {
    ...
    public void onJoin(EventPlayerJoin eventPlayerJoin) {
        ...
        if (entity != null && message.getValue()) {
            ChatManager.printChatNotifyClient((Object)ChatFormatting.GOLD + entity.getName() + (Object)ChatFormatting.GREEN + " logged in" + (Object)ChatFormatting.WHITE + (coords.getValue() ? " at [" + (int)entity.posX + ", " + (int)entity.posY + ", " + (int)entity.posZ + "]!" : "!"));
        }
    ...
    public void onLeave(EventPlayerLeave eventPlayerLeave) {
        ...
        if (message.getValue()) {
            ChatManager.printChatNotifyClient((Object)ChatFormatting.GOLD + event.getName() + (Object)ChatFormatting.RED + " logged out" + (Object)ChatFormatting.WHITE + (coords.getValue() ? " at [" + (int)entity2.posX + ", " + (int)entity2.posY + ", " + (int)entity2.posZ + "]!" : "!"));
        }
