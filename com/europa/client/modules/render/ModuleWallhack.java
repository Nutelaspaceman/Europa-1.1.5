...
extends Module {
    ...
    public static boolean containsBlock(Block block) {
        ...
        if (Mode.getValue().equals("Normal") && block2 != null) {
            return blocks.contains((Object)block2);
        }
    ...
    public void onGetBlockRenderLayer(EventBlockGetRenderLayer eventBlockGetRenderLayer) {
        block0: {
            void event;
            if (blocks.contains((Object)event.getBlock()) || ModuleWallhack.containsBlock(event.getBlock())) break block0;
     ...
     * WARNING - void declaration
     */
    public static void processShouldSideBeRendered(Block block, IBlockState iBlockState, IBlockAccess iBlockAccess, BlockPos blockPos, EnumFacing enumFacing, CallbackInfoReturnable<Boolean> callbackInfoReturnable) {
        block0: {
            void callback;
            Block block2;
            if (!blocks.contains((Object)block2)) break block0;
     ...
     * WARNING - void declaration
     */
    public static void processGetLightValue(Block block, CallbackInfoReturnable<Integer> callbackInfoReturnable) {
        block0: {
            void callback;
            Block block2;
            if (!blocks.contains((Object)block2)) break block0;
