    ...
    public void onRender3D(EventRender3D eventRender3D) {
        ...
        for (Entity entity : ModuleTrails.mc.world.loadedEntityList) {
            ...
            for (int i = 0; i < this.renderMap.get((Object)entity).size() - 1; ++i) {
                ...
                Vec3d pos = ModuleTrails.updateToCamera(this.renderMap.get((Object)entity).get(i));
                Vec3d pos2 = ModuleTrails.updateToCamera(this.renderMap.get((Object)entity).get(i + 1));
